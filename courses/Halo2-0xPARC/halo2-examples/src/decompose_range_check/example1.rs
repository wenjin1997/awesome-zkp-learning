...
/// 
/// Internally, this gadget use the `range_check` helper, which provides a K-bit
/// lookup table.
/// 
...
impl<F: FieldExt + PrimeFieldBits, const LOOKUP_NUM_BITS: usize, const LOOKUP_RANGE: usize> DecomposeConfig<F, LOOKUP_NUM_BITS, LOOKUP_RANGE> {
...
#[cfg(test)]
mod tests {
    use halo2_proofs::{circuit::{self, floor_planner::V1, SimpleFloorPlanner}, dev::MockProver, pasta::Fp};
    use rand::random;
    ...
    fn print_decompose_1() {
        ...
        let root = BitMapBackend::new("decompose-layout-SimpleFloorPlanner.png", (1024, 3096)).into_drawing_area();
